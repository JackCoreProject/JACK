...
#ifndef JACK_ZJACKWALLET_H
#define JACK_ZJACKWALLET_H
...
public:
    CzJACKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZJACK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZJACK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
