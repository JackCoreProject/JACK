...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    // TODO: Genesis block hash here
    (0, uint256("0000024751832ce5841a95d00998cf7094b552ebfdc6e953c2e2921acef246f9")); //GENESIS
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1561455218, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of
    (0, uint256("000004eccabfa23030f0535eb5b6535f4587908ce50a356508940b33e465066e"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("000001a0d6db8ffb3ba64942516c56fb645d14d6c78d26cd58e66eb0dcc450b6"));
...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 200; // TODO: Check it
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "We have to make a Jack Pot";
	...
	std::cout << genesis.ToString() << std::endl;
        ...
        vSeeds.push_back(CDNSSeedData("seed1.nsseed.jackcore.org", "seed1.nsseed.jackcore.org"));
        ...
        nZerocoinRequiredStakeDepth = 199; //The required confirmations for a zJACK to be stakable
...
public:
    CTestNetParams()
    {
       ...
       //  assert(hashGenesisBlock == uint256("0x000004eccabfa23030f0535eb5b6535f4587908ce50a356508940b33e465066e"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "jack-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "jack-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.jack.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet jack addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet jack script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet jack BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet jack BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet jack BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // JACK: 1 day
        nTargetSpacing = 1 * 60;        // JACK: 1 minutes
