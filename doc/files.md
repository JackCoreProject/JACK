...
jack.conf           | contains configuration settings for jackd or jack-qt
jackd.pid           | stores the process id of jackd while running
...
debug.log           | contains debug information and general logging generated by jackd or jack-qt
