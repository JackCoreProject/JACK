...
This means one can have an always-on jackd instance running, and another local jackd/jack-qt instance which connects to this node and receives blocks from it.
