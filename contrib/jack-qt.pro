...
RESOURCES += src/qt/jack.qrc src/qt/jack_locale.qrc

TRANSLATIONS += src/qt/locale/jack_bg.ts \
                src/qt/locale/jack_de.ts \
                src/qt/locale/jack_en.ts \
                src/qt/locale/jack_es.ts \
                src/qt/locale/jack_fi.ts \
                src/qt/locale/jack_fr.ts \
                src/qt/locale/jack_it.ts \
                src/qt/locale/jack_ja.ts \
                src/qt/locale/jack_pl.ts \
                src/qt/locale/jack_pt.ts \
                src/qt/locale/jack_ru.ts \
                src/qt/locale/jack_sk.ts \
                src/qt/locale/jack_sv.ts \
                src/qt/locale/jack_vi.ts \
                src/qt/locale/jack_zh_CN.ts \
                src/qt/locale/jack_zh_TW.ts
