Contributing to JACK Core
============================

The JACK Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/jack-project/jack/blob/master/doc/translation_process.md)
...
The following applies to code changes to the JACK Core project, and is not to be
confused with overall JACK Network Protocol consensus changes.

Whether a pull request is merged into JACK Core rests with the project merge
...
Patches that change JACK consensus rules are considerably more involved than
...
Where a patchset proposes to change the JACK consensus, it must have been
...
The project leader is the release manager for each JACK Core release.
